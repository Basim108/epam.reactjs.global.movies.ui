...
export default {
    ...
    argTypes: {
        ...
        onReset: {
            type: 'function',
            description: 'an optional callback function that will be invoked when a user clicks on reset button. If not passed then reset button will not be rendered.'
        }
    },
    parameters: {
        backgrounds: {
